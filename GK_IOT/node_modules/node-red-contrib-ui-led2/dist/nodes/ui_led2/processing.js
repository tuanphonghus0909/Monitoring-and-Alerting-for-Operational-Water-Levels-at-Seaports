...
//console.log("#7 prozessing: value " + JSON.stringify(value, null, 2));
    try {
...
const beforeEmitFactory = (node, RED, property) => {
    return (
...
//console.log("#46 processing msg: " + JSON.stringify(msg, null, 2));
//console.log("#47 processing value: " + JSON.stringify(value, null, 2));
//console.log("#47 processing property: " + JSON.stringify(property, null, 2));
//console.log("#48 processing config.property: " + JSON.stringify(config.property, null, 2));
//console.log("#49 processing value: " + JSON.stringify(value, null, 2));
var val = RED.util.getMessageProperty(msg, property);   //neu HL
//console.log("#52 processing val: " + JSON.stringify(val, null, 2));
        const [color, glow] = getColorForValue(colorForValue, val, RED);  //neu HL hier das property angegeben
        return {
            msg: {
                ...msg,
                color,
