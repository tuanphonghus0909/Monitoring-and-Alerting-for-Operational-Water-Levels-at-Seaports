    ...
    ***************************************************************************** */
    ...
    var setupPreviewUpdating = function (node, RED) {
        ...
        var latestConfig = {
            ...
            label: node.label,
property: node.property || 'payload',    //neu HL
    ...
    RED.nodes.registerType('ui_led2', {
        category: 'dashboard',
        paletteLabel: 'led2',
        ...
        property: { value: "payload", required: true }  //neu HL
    });

}());
</script>
<script type="text/html" data-template-name="ui_led2">
  <style>
    .showingPreview {
...
<script type="text/html" data-help-name="ui_led2">
