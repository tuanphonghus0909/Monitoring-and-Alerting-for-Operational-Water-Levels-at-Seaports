...
//console.log("#15 ui_led2 config: " + JSON.stringify(config, null, 2));
            ...
            this.property = config.property !== undefined ? config.property : "payload";  //neu HL
            ...
            const width = utility_1.tryForInt(config.width) ||
                ...
                undefined;
//console.log("#29 ui_led2 config: " + JSON.stringify(config, null, 2));
            ...
            const done = ui.addWidget({
                ...
                beforeEmit: processing_1.beforeEmitFactory(this, RED, config.property),  //neu HL
    ...
    RED.nodes.registerType('ui_led2', LEDNodeConstructor);
};
module.exports = nodeInit;
//# sourceMappingURL=ui_led2.js.map
